...
- **Fully local and offline** — no OpenAI, no cloud APIs, no telemetry
...
- **Audio quality sensitivity** — background noise or unclear speech will degrade transcription accuracy
...
- Add support for additional local LLMs via Ollama (e.g., `llama3`, `mistral`)
